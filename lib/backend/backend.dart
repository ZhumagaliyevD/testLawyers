...
Stream<List<AdvicesRecord>> queryAdvicesRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(AdvicesRecord.collection, AdvicesRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<AdvicesRecord>> queryAdvicesRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(AdvicesRecord.collection, AdvicesRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<AdvicesRecord>> queryAdvicesRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
...
Stream<List<ScheduleRecord>> queryScheduleRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(ScheduleRecord.collection, ScheduleRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<ScheduleRecord>> queryScheduleRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(ScheduleRecord.collection, ScheduleRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
